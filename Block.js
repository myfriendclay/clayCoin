...
export default class Block {
  ...
  calculateHash() {
    return SHA256(this.timestamp + JSON.stringify(this.transactions) + this.previousHash + this.height + this.nonce).toString()
  }
  ...
  isValidBlock() {
    return this.hasValidTransactions() && this.hasProofOfWork() && this.hasValidHash()
  }
}